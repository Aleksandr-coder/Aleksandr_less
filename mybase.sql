...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Янв 19 2023 г., 00:55
...
INSERT INTO `user` (`id`, `first_name`, `email`, `phone`) VALUES
(1, 'First', 'test@test.com', 123456789),
(2, '', 'test2@gmail.com', 1234567890),
(144, 'Bond', 'Bond@email.com', 7543);
